(() => {
    ...
    class n {
        constructor() {
            this.chunkedMTU = 16300 // The original 60000 bytes setting does not work when sending data from Firefox to Chrome, which is "cut off" after 16384 bytes and delivered individually.
                , // Binary stuff
                this._dataCount = 1, this.chunk = e => {
                    let t = [],
                        n = e.byteLength,
    ...
    class s {
        ...
        unpack_string(e) {
            ...
            let r = this.read(e),
                i = 0,
                o = "";
            for (; i < e;)(t = r[i]) < 160 ? ( // One-byte sequence: bits 0xxxxxxx
                ...
                n = (7 & t) << 18 | (63 & r[i + 1]) << 12 | (63 & r[i + 2]) << 6 | 63 & r[i + 3], i += 4), o += String.fromCodePoint(n);
    ...
    class a {
        ...
        pack(e) {
            if ("string" == typeof e) this.pack_string(e);
                ...
                if (null === e) this._bufferBuilder.append(192);
                    ...
                    let t = e.constructor;
                    if (e instanceof Array) this.pack_array(e);
                    ...
                    else if (t == Object || t.toString().startsWith("class")) this.pack_object(e);
        ...
        pack_array(e) {
            ...
            for (let n = 0; n < t; n++) this.pack(e[n])
        }
        pack_integer(e) {
        ...
        pack_double(e) {
            ...
            this._bufferBuilder.append(203), this.pack_int32(o), this.pack_int32(i % 4294967296)
        }
        pack_object(e) {
            let t = Object.keys(e),
                n = t.length;
            ...
            for (let t in e) e.hasOwnProperty(t) && (this.pack(t), this.pack(e[t]))
        }
        pack_uint8(e) {
    ...
    function L(e, t) {
        ...
        let r = function(e) {
            ...
            i = function(e, i) {
                ...
                if (e && "object" == typeof e.video) { // Shim facingMode for mobile & surface pro.
    ...
    function N(e) {
        ...
        if (!("getStats" in e.RTCRtpSender.prototype)) {
            ...
            n && (e.RTCPeerConnection.prototype.addTrack = function() {
                ...
                let e = this;
                return this._pc.getStats().then(t =>
        ...
        if (!("getStats" in e.RTCRtpSender.prototype && "getStats" in e.RTCRtpReceiver.prototype)) return; // shim RTCPeerConnection.getStats(track).
        let t = e.RTCPeerConnection.prototype.getStats;
        e.RTCPeerConnection.prototype.getStats = function() {
    ...
    function $(e) { // shim addTrack/removeTrack with native variants in order to make
        ...
        e.RTCPeerConnection.prototype.removeTrack = function(e) {
            return this._shimmedLocalStreams = this._shimmedLocalStreams || {}, e && Object.keys(this._shimmedLocalStreams).forEach(t => {
                let n = this._shimmedLocalStreams[t].indexOf(e); - 1 !== n && this._shimmedLocalStreams[t].splice(n, 1), 1 === this._shimmedLocalStreams[t].length && delete this._shimmedLocalStreams[t]
    ...
    function J(e, t) {
        ...
        e.RTCPeerConnection.prototype.addStream = function(t) { // Add identity mapping for consistency with addTrack.
        ...
        e.RTCPeerConnection.prototype.removeStream = function(e) {
            ...
            if (1 !== r.length || !r[0].getTracks().find(e => e === t)) // [[associated MediaStreams]] internal slot.
            ...
            if (o) // this is using odd Chrome behaviour, use with caution:
        ...
        Object.defineProperty(e.RTCPeerConnection.prototype, "localDescription", {
            ...
            let t;
            if ("closed" === this.signalingState) throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.", "InvalidStateError"); // We can not yet check for sender instanceof RTCRtpSender
            // since we shim RTPSender. So we check if sender._pc is set.
            if (!e._pc) throw new DOMException("Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender.", "TypeError");
            let n = e._pc === this;
            if (!n) throw new DOMException("Sender was not created by this connection.", "InvalidAccessError"); // Search for the native stream the senders track belongs to.
    ...
    e(j, "shimMediaStream", () => B), e(j, "shimOnTrack", () => F), e(j, "shimGetSendersWithDtmf", () => z), e(j, "shimGetStats", () => U), e(j, "shimSenderReceiverGetStats", () => N), e(j, "shimAddTrackRemoveTrackWithNative", () => $), e(j, "shimAddTrackRemoveTrack", () => J), e(j, "shimPeerConnection", () => V), e(j, "fixNegotiationNeeded", () => G), e(j, "shimGetUserMedia", () => L), e(j, "shimGetDisplayMedia", () => A);
    var W = {};

    function H(e, t) {
        let n = e && e.navigator,
            r = e && e.MediaStreamTrack;
        if (n.getUserMedia = function(e, t, r) { // Replace Firefox 44+'s deprecation warning with unprefixed version.
            ...
            if (r && r.prototype.applyConstraints) {
                ...
                r.prototype.applyConstraints = function(n) {
                    return "audio" === this.kind && "object" == typeof n && (e(n = JSON.parse(JSON.stringify(n)), "autoGainControl", "mozAutoGainControl"), e(n, "noiseSuppression", "mozNoiseSuppression")), t.apply(this, [n])
                }
            }
        }
    }
    ...
    function Y(e, t) {
        e.navigator.mediaDevices && "getDisplayMedia" in e.navigator.mediaDevices || !e.navigator.mediaDevices || (e.navigator.mediaDevices.getDisplayMedia = function(n) {
            if (!(n && n.video)) {
                ...
                return e.name = "NotFoundError", // from https://heycam.github.io/webidl/#idl-DOMException-error-names
    ...
    function ee(e) { // rename DataChannel to RTCDataChannel (native fix in FF60):
    ...
    function et(e) { // https://github.com/webrtcHacks/adapter/issues/998#issuecomment-516921647
        ...
        t && (e.RTCPeerConnection.prototype.addTransceiver = function() {
            ...
            let r = t.apply(this, arguments);
            if (n) { // Check if the init options were applied. If not we do this in an
                ...
                "encodings" in n && // Avoid being fooled by patched getParameters() below.
                    (1 !== n.encodings.length || 0 !== Object.keys(n.encodings[0]).length) || (n.encodings = e, t.sendEncodings = e, this.setParametersPromises.push(t.setParameters(n).then(() => {
    ...
    function el(e) {
        let t = e && e.navigator;
        if (t.mediaDevices && t.mediaDevices.getUserMedia) { // shim not needed in Safari 12.1
    ...
    function e_(e) { // foundation is arbitrarily chosen as an indicator for full support for
        ...
        e.RTCIceCandidate = function(e) {
                if ("object" == typeof e && e.candidate && 0 === e.candidate.indexOf("a=") && ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substring(2)), e.candidate && e.candidate.length) { // Augment the native candidate with the parsed fields.
                    let r = new n(e),
                        i = /*@__PURE__*/ t(eg).parseCandidate(e.candidate);
    ...
    function eC(e) {
        !e.RTCIceCandidate || e.RTCIceCandidate && "relayProtocol" in e.RTCIceCandidate.prototype || // Hook up the augmented candidate in onicecandidate and
            ...
            d(e, "icecandidate", e => {
                if (e.candidate) {
                    let n = /*@__PURE__*/ t(eg).parseCandidate(e.candidate.candidate);
    ...
    function ev(e, n) {
        ...
        let r = function(e) {
                if (!e || !e.sdp) return !1;
                let n = /*@__PURE__*/ t(eg).splitSections(e.sdp);
                return n.shift(), n.some(e => {
                    let n = /*@__PURE__*/ t(eg).parseMLine(e);
                    return n && "application" === n.kind && -1 !== n.protocol.indexOf("SCTP")
                })
            },
            i = function(e) { // TODO: Is there a better solution for detecting Firefox?
                let t = e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);
                if (null === t || t.length < 2) return -1;
                let n = parseInt(t[1], 10); // Test for NaN (yes, this is ugly)
                return n != n ? -1 : n
            },
            ...
            s = function(e, r) { // Note: 65536 bytes is the default value from the SDP spec. Also,
                ...
                let o = /*@__PURE__*/ t(eg).matchPrefix(e.sdp, "a=max-message-size:");
        ...
        e.RTCPeerConnection.prototype.setRemoteDescription = function() { // Chrome decided to not expose .sctp in plan-b mode.
            ...
            if (r(arguments[0])) {
                ...
                let t = i(arguments[0]),
                    n = o(t),
                    r = s(arguments[0], t);
                e = 0 === n && 0 === r ? Number.POSITIVE_INFINITY : 0 === n || 0 === r ? Math.max(n, r) : Math.min(n, r); // Create a dummy RTCSctpTransport object and the 'maxMessageSize'
                // attribute.
                let a = {};
    ...
    ey.generateIdentifier = function() {
        ...
        ey.parseRtpMap = function(e) {
            ...
            return t = t[0].split("/"), n.name = t[0], n.clockRate = parseInt(t[1], 10), n.channels = 3 === t.length ? parseInt(t[2], 10) : 1, // legacy alias, got renamed back to channels in ORTC.
        ...
        ey.parseRtpParameters = function(e) {
            ...
            for (let n = 3; n < r.length; n++) {
                ...
                if (o) {
                    let n = ey.parseRtpMap(o),
                        r = ey.matchPrefix(e, "a=fmtp:" + i + " "); // parse FEC mechanisms from rtpmap lines.
                    switch ( // Only the first a=fmtp:<pt> is considered.
                        n.parameters = r.length ? ey.parseFmtp(r[0]) : {}, n.rtcpFeedback = ey.matchPrefix(e, "a=rtcp-fb:" + i + " ").map(ey.parseRtcpFb), t.codecs.push(n), n.name.toUpperCase()) {
                        case "RED":
                        case "ULPFEC":
            ...
            let i = ey.matchPrefix(e, "a=rtcp-fb:* ").map(ey.parseRtcpFb); // FIXME: parse rtcp.
        ...
        ey.writeRtpDescription = function(e, t) {
            ...
            let r = 0; // FIXME: write fecMechanisms.
            return t.codecs.forEach(e => {
        ...
        ey.parseRtcpParameters = function(e) {
            ...
            n && (t.cname = n.value, t.ssrc = n.ssrc); // Edge uses the compound attribute instead of reducedSize
            // compound is !reducedSize
            let r = ey.matchPrefix(e, "a=rtcp-rsize");
            t.reducedSize = r.length > 0, t.compound = 0 === r.length; // parses the rtcp-mux attrіbute.
    ...
    let ew = function({
            ...
            let n = function(e) { // Returned result object.
                    ...
                    return n.mozGetUserMedia ? (t.browser = "firefox", t.version = p(n.userAgent, /Firefox\/(\d+)\./, 1)) : n.webkitGetUserMedia || !1 === e.isSecureContext && e.webkitRTCPeerConnection ? ( // Chrome, Chromium, Webview, Opera.
            ...
            switch (n.browser) {
                case "chrome":
                    ...
                    f("adapter.js shimming chrome."), // Export to the adapter global object visible in the browser.
                        r.browserShim = j, // Must be called before shimPeerConnection.
                        eT(e, n), eR(e, n), j.shimGetUserMedia(e, n), j.shimMediaStream(e, n), j.shimPeerConnection(e, n), j.shimOnTrack(e, n), j.shimAddTrackRemoveTrack(e, n), j.shimGetSendersWithDtmf(e, n), j.shimGetStats(e, n), j.shimSenderReceiverGetStats(e, n), j.fixNegotiationNeeded(e, n), e_(e, n), eC(e, n), ek(e, n), ev(e, n), eb(e, n), eS(e, n);
                    break;
                case "firefox":
                    ...
                    f("adapter.js shimming firefox."), // Export to the adapter global object visible in the browser.
                ...
                case "safari":
                    ...
                    f("adapter.js shimming safari."), // Export to the adapter global object visible in the browser.
                        r.browserShim = eo, // Must be called before shimCallbackAPI.
                        eT(e, n), eR(e, n), eo.shimRTCIceServerUrls(e, n), eo.shimCreateOfferLegacy(e, n), eo.shimCallbacksAPI(e, n), eo.shimLocalStreamsAPI(e, n), eo.shimRemoteStreamsAPI(e, n), eo.shimTrackEventTransceiver(e, n), eo.shimGetUserMedia(e, n), eo.shimAudioContext(e, n), e_(e, n), eC(e, n), ev(e, n), eb(e, n), eS(e, n);
                    break;
                default:
                        ...
                        try {
                            ...
                            try {
                                n = e.createDataChannel("_PEERJSTEST", {
                                    ordered: !0
                                }), t.data = !0, t.reliable = !!n.ordered; // Binary test
                                try {
    ...
    Object.create && (eB.prototype = Object.create(null), new eB().__proto__ || (eA = !1)),
        ...
        eN.prototype.emit = function(e, t, n, r, i, o) {
            ...
            if (l.fn) {
                ...
                for (c = 0; c < h; c++) switch (l[c].once && this.removeListener(e, l[c].fn, void 0, !0), p) {
                    ...
                    default:
                        if (!a)
                            for (d = 1, a = Array(p - 1); d < p; d++) a[d - 1] = arguments[d];
        ...
        eN.prototype.removeListener = function(e, t, n, r) {
            ...
            if (!t) return eU(this, i), this;
            var o = this._events[i];
            if (o.fn) o.fn !== t || r && !o.once || n && o.context !== n || eU(this, i);
            else {
        ...
        eN.prototype.removeAllListeners = function(e) {
            var t;
            return e ? (t = eA ? eA + e : e, this._events[t] && eU(this, t)) : (this._events = new eB, this._eventsCount = 0), this
        }, //
    ...
    class eJ extends ej.EventEmitter {
        ...
        _sendQueuedMessages() { //Create copy of queue and clear it,
    ...
    class eV {
        ...
        _setupListeners(e) {
            ...
            eO.log("Listening for ICE candidates."), e.onicecandidate = e => {
                ...
                }, eO.log("Listening for data channel"), // Fired between offer and answer, so options should already be saved
                // in the options hash.
                e.ondatachannel = e => {
        ...
        async _makeOffer() {
            ...
            try {
                ...
                } catch (e) { // TODO: investigate why _makeOffer is being called from the answer
    ...
    class eK {
        _buildRequest(e) {
            ...
            return ( // TODO: Why timestamp, why random?
                s.searchParams.set("ts", `${Date.now()}${Math.random()}`), s.searchParams.set("version", e$.version), fetch(s.href, {
    ...
    class eQ extends eq {
        ...
        _handleChunk(e) {
            ...
            if (n.data[e.n] = new Uint8Array(e.data), n.count++, this._chunkedData[t] = n, n.total === n.count) { // Clean up before making the recursive call to `_handleDataMessage`.
    ...
    class e0 extends eq { // Handles a DataChannel message.
        _handleDataMessage({
            data: e
        }) {
        ...
        _handleMessage(e) {
            ...
            switch (t) {
                ...
                case O.Expire:
                    ...
                    break;
                case O.Offer: { // we should consider switching this to CALL/CONNECT, but this is the least breaking option.
                    let e = n.connectionId,
                        t = this.getConnection(r, e); // Create a new connection.
